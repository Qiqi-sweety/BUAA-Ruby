...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference("Rider.count") do
      post riders_url, params: { rider: { address: @rider.address, name: @rider.name, telephone: @rider.telephone, user_id: @rider.user_id } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { address: @rider.address, name: @rider.name, telephone: @rider.telephone, user_id: @rider.user_id } }
